...
<form id="form" name="form" method="post"
	action="<c:url value='/consommation/importfile'/>"
	enctype="multipart/form-data">


	<h3>Importation Téléphonie Mobile</h3>
	...
	<div style="margin-right: 10px; margin-left: 10px;">
		<br>
		<br> * Le nom du ficher zip ne doit pas contenir d'accents ou de
		caractères spéciaux. <br> <span style="color: red">* Champ
			obligatoire.</span>
	</div>
...
if(saveMessage!=null&&saveMessage.trim().length>0){
	 $("#idimportinfo").html(saveMessage);
		...
		if(isexportcsv=="true"){
			document.location.href = '<c:url value="/consommation/exportcsv" />';
			}
